...
dimension: lead_owner {
  type: string
  sql:  CASE
          WHEN RIGHT(${lead_id},3) = 'EAG' THEN 'Michael Moore'
          WHEN RIGHT(${lead_id},3) = 'EAW' THEN 'William Brown'
          WHEN RIGHT(${lead_id},3) = 'EAO' THEN 'Jane Anderson'
          WHEN RIGHT(${lead_id},3) = 'EA4' THEN 'Daniel Brown'
          WHEN RIGHT(${lead_id},3) = 'EAS' THEN 'Evelyn White'
          WHEN RIGHT(${lead_id},3) = 'EAC' THEN 'Ava Brown'
          WHEN RIGHT(${lead_id},3) = 'EAK' THEN 'Emily Wilson'
          WHEN RIGHT(${lead_id},3) = 'EA0' THEN 'Amelia Williams'
          ELSE 'Unknown' END
 ;;
}
